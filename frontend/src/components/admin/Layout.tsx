"use client";
import LayoutMenuMobile from "@/components/admin/LayoutMenuMobile";
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex min-h-screen w-full">
          ...
          <nav className="mt-6 flex flex-col space-y-1">
            {navigation.map((item) => (
              <Link
                ...
                href={item.href}
                className={clsx(
                  'transition-colors" flex items-center gap-2 rounded-md px-3 py-2 text-sm font-medium',
                  {
        ...
        <div className="flex flex-1 flex-col">
          ...
          <main className="bg-muted/40 flex-1 p-4">{children}</main>
        </div>
      </div>
    </div>
  );
